...
function SidebarCard() {
    ...
    return (
        <div onMouseEnter={handleHover} onMouseLeave={handleHover} className={ hover == true ?'bg-colorfull w-full rounded-[20px] p-5 pt-10 pb-20 mt-[-180px] duration-300' : 'bg-colorfull w-full rounded-[20px] p-5 pt-10 pb-20 mt-[25px] duration-200'}>
            <ul>
