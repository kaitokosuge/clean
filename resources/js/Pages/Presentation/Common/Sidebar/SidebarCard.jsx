...
function SidebarCard() {
    ...
    return (
        <div onMouseEnter={handleHover} onMouseLeave={handleHover} className={ hover == true ? 'bg-colorfull w-[150%] rounded-[20px] p-5 pt-10 pb-20 mt-[-250px] duration-300 overflow-scroll h-[400px]' : 'w-[100%] bg-colorfull w-full rounded-[20px] p-5 pt-10 pb-20 mt-[25px] h-[400px] duration-700'}>
            <ul>
