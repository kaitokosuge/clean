        ...
        <div className="w-[82%] min-w-[50%] h-[150px] fixed bottom-0 z-10 right-0 bg-shadow">
            <div className="flex items-center">
                <form onSubmit={handleArticleFormSubmit} className="w-full flex items-center mt-5 relative">
                    ...
                    <div onMouseLeave={ handleHover } className={ isHover == true ? "absolute bottom-[0px] right-[0%] block opacity-100 visible border border-zinc-600 bg-zinc-900 rounded-[5px] p-[25px] max-h-[400px] w-[350px] overflow-scroll duration-300 z-30" : "w-[350px] absolute bottom-0 right-[1%] p-[25px] opacity-0 duration-500 invisible max-h-[400px]"}>
