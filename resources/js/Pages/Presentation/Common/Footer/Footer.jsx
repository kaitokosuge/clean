        ...
        <div className="w-[82%] min-w-[50%] h-[150px] fixed bottom-0 z-10 right-0 bg-shadow">
            <div className="flex items-center">
                <form onSubmit={handleArticleFormSubmit} className="w-full flex items-center mt-5 relative">
                    <input onChange={ handleArticleObj } name="url" type='text' placeholder="add article" value={formArticleValue.url} autocomplete='off'className="block outline-none mt-[40px] ml-[150px] w-[60%] min-w-[200px] h-[60px] py-[5px] px-[10px] rounded-md bg-[#202020] duration-200 focus:border-gray-300 focus:ring-sky-900 focus:duration-200"/>
                    ...
                    <div onMouseLeave={ handleHover } className={ isHover == true ? "absolute bottom-[0px] right-[5%] block opacity-100 visible border border-zinc-600 bg-zinc-900 rounded-[5px] p-[25px] max-h-[400px] w-[350px] overflow-scroll duration-300 z-30" : "w-[350px] absolute bottom-0 right-[5%] opacity-0 duration-300 invisible max-h-[400px]"}>
